...
class ResNetMulti(nn.Module):
    ...
    def optim_parameters(self, cfg):
        optim_parameters = [{'params': self.get_1x_lr_params_NOscale(), 'lr': cfg.opt.lr},
                            {'params': self.get_10x_lr_params(), 'lr': 10*cfg.opt.lr}]
        if self.tm:
            optim_parameters += [{'params': self.TM_params(), 'lr': 10 * cfg.opt.lr}]
