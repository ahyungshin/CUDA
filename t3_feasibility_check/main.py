...
################################
        ...
        saved_state_dict0 = torch.load('/data/shinahyung/code/3CUDA/0418/Target3/0427/NEW/finetuning_feasibility_check/GTA5_150000.pth', map_location=self.device)
...
################################
        ...
        saved_state_dict1 = torch.load('/data/shinahyung/code/3CUDA/0418/Target3/0427/NEW/finetuning_feasibility_check/target1.pth', map_location=self.device)
...
################################
        ...
        saved_state_dict2 = torch.load('/data/shinahyung/code/3CUDA/0418/Target3/0427/NEW/finetuning_feasibility_check/target2.pth', map_location=self.device)
...
# ################################
    ...
    def train_one_epoch(self):
        ...
        for batch_idx, (batch_s, batch_t) in enumerate(tqdm(
            ...
            with torch.no_grad():
################################ Pseudo1
                pseudo_outputs0_2, pseudo_outputs0_1 = self.ref_model0(x.to(self.device), forward_target=0) # Source (S)
                pseudo_outputs1_2, pseudo_outputs1_1 = self.ref_model1(x.to(self.device), forward_target=1) # Cityscapes (T1)
                pseudo_outputs2_2, pseudo_outputs2_1 = self.ref_model2(x.to(self.device), forward_target=1) # IDD (T2)
                pseudo_outputs3_2, pseudo_outputs3_1 = self.model(x.to(self.device), forward_target=3) # Source + TM3
